...
from SplaTAM.utils.eval_helpers import eval
        ...
        if time_idx == 0 or (time_idx+1) % config['map_every'] == 0:
            ...
            if config['mapping']['add_new_gaussians'] and time_idx > 0:
                ...
                if seperate_densification_res:
                    ...
                    densify_factor = dataset_config['desired_image_height'] // dataset_config['densification_image_height']
                    densify_curr_data = {'cam': densify_cam,
                        'im': color[:, ::densify_factor, ::densify_factor],
                        'depth': depth[:, ::densify_factor, ::densify_factor], 'id': time_idx, 
